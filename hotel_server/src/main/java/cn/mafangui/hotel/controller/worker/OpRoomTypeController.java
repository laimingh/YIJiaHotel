...
public class OpRoomTypeController {
    ...
    public AjaxResult addRoomType(String roomType,Double price,Double discount,Integer area,
                           Integer bedNum,String personNumber,Integer window,String remark,Integer rest,String urlq){
        RoomType rt = new RoomType(roomType,remark,price,discount,area,bedNum,personNumber,window,urlq);
        rt.setRest(rest);
    ...
    public AjaxResult updateRoomType(Integer typeId,String roomType,Double price,Double discount,Integer area,
                                     Integer bedNum,String personNumber,Integer window,Integer rest,String remark,String urlq){
        RoomType rt = new RoomType(roomType,remark,price,discount,area,bedNum,personNumber,window,urlq);
        rt.setTypeId(typeId);
        rt.setRest(rest);
