  ...
  <div class="hello"  >
    <div class="header">
      <mu-paper class="banner">
        ...
        <h1 style="color: #000000">{{ hotelInfo.hotelName }}</h1>
        <h2 style="color: #000000">欢迎管理员登录</h2>
<!--        <p v-if="!isLogin()">-->
...
<!--        </p>-->
        <p >
          ...
          <mu-button color="" style="height: 100px;width: 100px" @click="navigateTo('/roomState')">
            客房状态
          </mu-button>
          <mu-button color="" style="height: 100px;width: 100px"  @click="navigateTo('/manageIndex')">
            销售记录
          </mu-button>
          <mu-button color="" style="height: 100px;width: 100px" @click="navigateTo('/checkIn')">
            入住登记
          </mu-button>
          <mu-button color="" style="height: 100px;width: 100px"  @click="navigateTo('/userConfig')">
            用户管理
          </mu-button>
          <mu-button color="" style="height: 100px;width: 100px"  @click="navigateTo('')">
            订单查询
          </mu-button>
          <mu-button color="" style="height: 100px;width: 100px"  @click="navigateTo('')">反馈信息</mu-button>
        </p>
      </mu-paper>
    </div>
    <!-- -->
...
.header >>>.mu-paper{
  ...
  background: url('https://pic.imgdb.cn/item/6289d7c70947543129e840bc.png')  ;
